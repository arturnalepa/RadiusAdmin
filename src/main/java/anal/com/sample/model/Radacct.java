...
/**
 * AcctStartTime - czas rozpocz�cia sesji
 * AcctStopTime - czas zatrzymania sesji
 * AcctSessionTime - czas sesji w sekundach
 * AcctInputOctects - ilo�� danych wys�anych przez u�ytkownika
 * AcctOutputOctects - ilo�� danych odebranych przez u�ytkownika
 * CalledStationId - identyfikator NAS, kt�ry obs�ugiwa� sesj�
 * AcctTerminationCause - co spowodowa�o wylogowanie u�ytkownika
 * CalledStationID - adres MAC urz�dzenia, z kt�rego u�ytkownik si� zalogowa�
 * w
 * FramedIPAddress - adres IP urz�dzenia, z kt�rego u�ytkownik si� zalogowa�
